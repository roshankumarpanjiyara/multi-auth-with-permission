...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="container-xxl" id="kt_content_container">
       ...
       <div class="row g-5 g-xl-8">
                ...
                <a href="{{route('users.index')}}" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">
                            <div id="user-count" data-max-number="{{App\Models\User::all()->count()}}">
                                0
                            </div>
                        </div>
            ...
            <div class="col-xl-3">
                <!--begin::Statistics Widget 5-->
                <a href="{{route('roles.index')}}" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                    <!--begin::Body-->
                    <div class="card-body">
                        ...
                        <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">
                            <div id="role-count" data-max-number="{{App\Models\Role::all()->count()}}">
                                0
                            </div>
                        </div>
                        <div class="fw-bold text-gray-100">Roles</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
            ...
            <div class="col-xl-3">
                <!--begin::Statistics Widget 5-->
                <a href="{{route('admins.index')}}" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                    <!--begin::Body-->
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">
                            <div id="admin-count" data-max-number="{{App\Models\Admin::all()->count()}}">
                                0
                            </div>
                        </div>
                        <div class="fw-bold text-gray-100">Admin</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
...
<!--end::Content-->
<script src="{{asset('number-rush.js')}}"></script>
<script>
    new numberRush('user-count', {
        speed: 50,
    });
    new numberRush('admin-count', {
        speed: 50,
    });
    new numberRush('role-count', {
        speed: 50,
    });
</script>
