...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>@yield('mytitle')MultiAuth</title>
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="d-flex flex-column flex-lg-row-auto w-xl-600px" style="background-color: #232f3e">
					...
					<div class="d-flex flex-column text-center p-10 pt-lg-20">
						<!--begin::Logo-->
						<a href="/" class="py-10">
							<img alt="Logo" src="{{asset("template/dist/assets/media/logos/logo-demo3-default.svg")}}" class="h-60px" />
						</a>
						<!--end::Logo-->
						<!--begin::Title-->
						<h1 class="fw-bolder fs-2qx pb-3 pb-md-10" style="color: #fc8902;">Welcome to MultiAuth</h1>
						<!--end::Title-->
						<!--begin::Description-->
					...
					<!--end::Header-->
					<!--begin::Illustration-->
					<div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px"  style="background-image: url(template/dist/assets/media/illustrations/dozzy-1/13.png);"></div>
					<!--end::Illustration-->
				</div>
				<!--end::Aside-->
                <style>
