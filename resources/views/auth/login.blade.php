    ...
    <div class="d-flex flex-column flex-lg-row-fluid py-10">
            ...
            <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                ...
                <form class="form w-100" method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">@csrf
                    ...
                    <div class="text-center mb-10">
                        ...
                        <a href="{{route('register')}}" class="text-color fw-bolder">Create an Account</a></div>
                        <!--end::Link-->
                    </div>
                    <!--begin::Heading-->
                    <!--begin::Input group-->
        ...
        <div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
            ...
            <div class="d-flex flex-center fw-bold fs-6">
                <a href="/about" class="text-muted text-hover-primary px-2" target="_blank" rel="noopener">About</a>
                <a href="/contact" class="text-muted text-hover-primary px-2" target="_blank" rel="noopener">Contact Us</a>
                <a href="/rental-service" class="text-muted text-hover-primary px-2" target="_blank" rel="noopener">Purchase</a>
            </div>
            <!--end::Links-->
        </div>
        <!--end::Footer-->
