    ...
    <div class="d-flex flex-column flex-lg-row-fluid py-10">
        ...
        <div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
            ...
            <div class="d-flex flex-center fw-bold fs-6">
                ...
                <a href="/contact" class="text-muted text-hover-primary px-2" target="_blank">Contact Us</a>
                <a href="/rental-service" class="text-muted text-hover-primary px-2" target="_blank">Purchase</a>
            </div>
            <!--end::Links-->
        </div>
        <!--end::Footer-->
